...
const VenueRegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Venue registration submitted successfully! We'll contact you soon.");
      setForm({
        venueName: "", venueType: "", contactPerson: "", email: "", phone: "", whatsapp: "",
        address: "", capacity: "", operatingHours: "", musicGenre: [], amenities: [],
        website: "", instagram: "", description: "", partnershipInterest: "", agreeToTerms: false
      });
    } catch (error) {
    ...
    <div className="form-container">
      <div className="container">
        <div className="section-header">
          ...
          <p>Register your venue to partner with Dubai's premier nightlife platform</p>
        </div>
            ...
            <div className="form-section">
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label>
                    Venue Type *
                    <select name="venueType" value={form.venueType} onChange={handleChange} className={errors.venueType ? 'error' : ''}>
                    ...
                    {errors.venueType && <span className="field-error">{errors.venueType}</span>}
                  </label>
                </div>
                <div className="form-group">
                  <label>
            ...
            <div className="form-section">
              ...
              <div className="form-grid">
                <div className="form-group full-width">
                  <label>
                    ...
                    <input type="text" name="address" value={form.address} onChange={handleChange}
                      placeholder="Full venue address" className={errors.address ? 'error' : ''} />
                ...
                <div className="form-group">
                  <label>
                    Operating Hours
                    <input type="text" name="operatingHours" value={form.operatingHours} onChange={handleChange}
            ...
            <div className="form-section">
              ...
              <div className="checkbox-group">
                ...
                <div className="checkbox-grid">
                  {['House', 'Techno', 'Tech House', 'Deep House', 'Progressive', 'Trance', 'Hip Hop', 'R&B', 'Commercial', 'Open Format'].map(genre => (
                    <label key={genre} className="checkbox-label">
                      <input type="checkbox" name="musicGenre" value={genre.toLowerCase()} 
                        onChange={handleChange} checked={form.musicGenre.includes(genre.toLowerCase())} />
                      <span>{genre}</span>
                    </label>
                  ))}
                </div>
              ...
              <div className="checkbox-group">
                ...
                <div className="checkbox-grid">
                  {['VIP Tables', 'Dance Floor', 'Outdoor Area', 'Pool', 'Shisha', 'Food Service', 'Valet Parking', 'Coat Check', 'Smoking Area', 'Private Rooms'].map(amenity => (
                    <label key={amenity} className="checkbox-label">
                      <input type="checkbox" name="amenities" value={amenity.toLowerCase()} 
                        onChange={handleChange} checked={form.amenities.includes(amenity.toLowerCase())} />
                      <span>{amenity}</span>
                    </label>
                  ))}
                </div>
              ...
              <div className="form-group full-width">
                <label>
                  ...
                  <textarea name="description" value={form.description} onChange={handleChange}
                    placeholder="Describe your venue's atmosphere, unique features, target audience..." rows="4" />
                </label>
              </div>
              <div className="form-group full-width">
                <label>
                  Partnership Interest
                  <select name="partnershipInterest" value={form.partnershipInterest} onChange={handleChange}>
                    <option value="">Select interest</option>
                    <option value="event-promotion">Event Promotion</option>
                    <option value="guestlist-management">Guestlist Management</option>
                    <option value="table-booking">Table Booking Service</option>
